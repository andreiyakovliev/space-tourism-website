(() => {
        ...
        function setTabsAction(e) {
            ...
            if (el.closest("[data-tabs-title]")) {
                ...
                if (!tabTitle.classList.contains("_tab-active") && !tabsBlock.querySelector("._slide")) {
                    ...
                    const tabImage = tabsBlock.querySelector("#tab-image");
                    const target = tabTitle.dataset.target;
                    const images = {
                        moon: "img/destination/moon.svg",
                        mars: "img/destination/mars.svg",
                        europa: "img/destination/europa.svg",
                        titan: "img/destination/titan.svg"
                    };
                    if (tabImage && images[target]) tabImage.src = images[target];
                }
                e.preventDefault();
            }
        }
    ...
    function initSliders() {
        if (document.querySelector(".crew-page__slider")) new swiper_core_Swiper(".crew-page__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    function changeSlideImage() {
        ...
        if (activeSlide && imageElement) {
            ...
            if (imageSrc) imageElement.src = `img/crew/${imageSrc}`;
        }
    }
    window.addEventListener("load", (() => {
        const swiperContainer = document.querySelector(".swiper");
        if (swiperContainer) swiperContainer.addEventListener("transitionend", (() => {
            changeSlideImage();
        }));
    }));
